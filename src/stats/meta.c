/*
 * stats/meta.c - Meta statistic definitions.
 *
 * This file contains the implementation for initializing, converting, and
 * freeing meta statistics. Meta statistics are calculated based on multiple
 * types of ngram statistics, allowing for higher-level analysis of keyboard
 * layouts.
 *
 * Adding new stats:
